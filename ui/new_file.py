...
################################################################################
## Form generated from reading UI file 'new_fileeXBmnL.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setFont(font)
        icon = QIcon()
        icon.addFile(u":/newPrefix/note_add_128dp_E3E3E3_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        self.ErrorsLable.setMinimumSize(QSize(504, 33))
        self.ErrorsLable.setMaximumSize(QSize(504, 33))
        font5 = QFont()
